        ...
        implements VerleihService
{
    ...
    {
        assert ausleihDatum != null : "Vorbedingung verletzt: ausleihDatum ist null"; // wenn false, dann wirft der Aufruf des Verleihkartekonstruktors eine NullPointerException, da dort #ausleihDatum als Parameter übergeben wird
    ...
    {
        assert kundeImBestand(
                kunde) : "Vorbedingung verletzt: kundeImBestand(kunde)"; //nur Kunden die im Bestand existieren sollten etwas ausleihen dürfen
        assert medienImBestand(
                medien) : "Vorbedingung verletzt: medienImBestand(medien)"; // nur Medien, die im Bestand vorhanden sind, könnten ausgeliehen werden
    ...
    {
        assert kundeImBestand(
                kunde) : "Vorbedingung verletzt: kundeImBestand(kunde)"; //kundeImBestand prüft, dass kunde!=null ist, sonst NullPointer beim equals aufruf in der Methode. Außerdem sollten nur Kunden im Bestand ausgeliehende Medien besitzen
